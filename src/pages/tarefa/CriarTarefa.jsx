    ...
    <Grid container spacing={2}>
      <Card sx={style}>
        ...
        <CardContent sx={{
          ...
          <Grid item xs={12}>  
            <FormControl fullWidth>
              <Input id="criador_tarefa" aria-describedby="tarefa_descricao_helper_text" value={criadoPor} onChange={e => { setCriadoPor(e.target.value) }} />
              <FormHelperText id="tarefa_descricao_helper_text">Criador da Tarefa.</FormHelperText>
            </FormControl>
          </Grid>
